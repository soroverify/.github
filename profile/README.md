...
Soroban doesn't store contract source on-chain. Soroverify closes that gap:
given a deployed contract and its claimed source, it rebuilds the source in
an isolated container and checks whether the result actually matches the
deployed Wasm.
